exports.config = {
    ...
    suites: {
        home: [
            './src/features/HomeAndErrorPage.feature',
        ],
        dataentry: [
            './src/features/OTPLogin.feature',
            './src/features/OverallStepRequired.feature',
        ],
        regression: [
            './src/features/HomeAndErrorPage.feature',
            './src/features/OTPLogin.feature',
            './src/features/OverallStepRequired.feature',
            './src/features/RiskQuestion.feature',
            './src/features/PreApprovePage.feature',
            './src/features/InputUserDetails.feature',
            './src/features/CaptureDocuments.feature',
            './src/features/DocumentReupload.feature',
        ],
    },
    //depricated warning
    ...
    // }
//to take screenshot for all

//    afterStep:function afterStep(setp){
//    var name = 'ERROR-chrome-' + Date.now()
//    browser.saveScreenshot('./errorShots/' + name + '.png')
//    },


// to take screenshot only on failure
